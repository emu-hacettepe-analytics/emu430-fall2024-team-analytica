...
-   In another graph, we determined the distribution of daily accident numbers.
...
-   The purpose of choosing this graph was to determine whether the number of accidents would increase or peak on special days or holidays. However, the result was not as we expected. For example, while the date of Eid al-Fitr is April 21, the day with the most accidents in that month is April 7.

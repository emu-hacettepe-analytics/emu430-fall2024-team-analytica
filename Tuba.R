...
# Installing packages
# Installing packages
.libPaths("D:/Projects/RTempLibrary")
install.packages("readxl", lib = "D:/Projects/RTempLibrary")
library(readxl, lib.loc = "D:/Projects/RTempLibrary")
.libPaths("D:/Projects/RTempLibrary")
install.packages("rstudioapi", lib = "D:/Projects/RTempLibrary")
library(rstudioapi, lib.loc = "D:/Projects/RTempLibrary")
...
#Şimdi de ben plotlarımı çizdiriyorum (Tuba)

# Kütüphaneleri yükleyin
library(ggplot2)
library(dplyr)

# 1. Eksik veya hatalı değerleri temizleyin
data_2023 <- data_2023 %>%
  filter(!is.na(ISTIKAMET) & !is.na(TUR))
...
unique(filtered_data$ISTIKAMET)
unique(filtered_data$TUR)
...
#aylara ve kaza türlerine göre kaza sayılarına bakma
# Tarih sütunundan ay bilgisini çekme
data_2023 <- data_2023 %>%
